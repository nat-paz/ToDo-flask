...
const formExc = document.querySelector(".formExc-js")
    ...
    function getData(data){
        data.map((item)=>{
            ...
            <tr>
                ...
                delete
                </span><span class="material-symbols-outlined text-success" type="button" data-bs-toggle="modal" data-bs-target="#modalEdit">
                edit
                </span></td>
            </tr>
            `
